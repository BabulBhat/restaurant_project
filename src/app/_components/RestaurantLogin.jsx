...
import { RestaurantLoginAuth } from "../redux/admin/auth/restaurantAuthSlice";
    ...
    <>
      <div className="login text-white w-full max-w-[350px] p-4 rounded-md shadow-lg border-1 backdrop-blur-lg">
        ...
        <div className="relative z-10 form-group">
          ...
          <input
            type="text"
            className="w-full px-3 py-2 border-1 border-gray-500 text-white rounded-md focus-visible:outline-none"
        ...
        <div className="relative z-10 form-group mt-4">
          <button
            className="bg-red-800 rounded-sm cursor-pointer hover:bg-yellow-600 text-white px-4 py-2"
            onClick={handleLogin}
            disabled={loading}
          >
        ...
        <div className="form=group">
          <button
            className="my-3 block cursor-pointer"
            onClick={() => {
              props.setLoginSignup(!props.loginSignup);
            }}
          >
