          ...
          <div className="grid grid-cols-4 gap-10 pt-14">
            <div className="cardCategories">
              ...
              <div className="text-center mt-4">
                <h3 className="text-2xl font-bold text-red-800 mb-1">Pizza</h3>
                <p className="text-gray-800 tracking-tighter">15 Restaurant Available</p>
              </div>
            </div>
            <div className="cardCategories">
              <div>
          ...
          >
            <SwiperSlide>
              <div className="relative bg-yellow-500 pt-7 px-4 rounded-lg text-center pb-13">
                <p className="mb-4 text-md tracking-tight">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti corporis nobis, quo suscipit nesciunt dolorum ut veritatis ullam dolores aperiam expedita quam, quae minima cumque sequi vero aliquid iure vitae.</p>
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-start">
            <div className="text-white w-full max-w-md">
              <span className="block text-xl font-light uppercase py-3">Free Home Delivery 30 min</span>
              <h2 className="text-4xl font-semibold mb-5">Get Your Order 24/7 Right At Your Doorsteps</h2>
              <p className="text-md mb-12">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam soluta, modi nihil blanditiis maxime fugiat quibusdam pariatur, error fuga, facere vero ab magnam itaque officia voluptatum beatae? Possimus, accusamus exercitationem?</p>
              <div className="flex items-center justify-start mt-5">
                <button className="cursor-pointer bg-red-800 px-4 py-3 rounded text-white text-sm uppercase font-semibold mr-4 hover:bg-yellow-600">Our Restaurant</button>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-3 gap-10">
            <div className="blogCard bg-white rounded-lg overflow-hidden shadow-gray-300 shadow-lg">
              ...
              <div className=" p-4">
                <span className="text-red-800 uppercase font-bold mb-3 block">Appetizers</span>
                <h4 className="text-2xl font-semibold text-gray-800 tracking-tight mb-2">Amazing Decadent Pecan PIE Best Cake</h4>
                <p className="text-gray-500 text-sm mb-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi dolores aspernatur minus porro labore tempora quos minima unde aperiam? Quam labore, natus porro laborum sed dicta fugit doloremque cupiditate earum!</p>
                <div className="flex items-center justify-start">
                  <Image
                    src={client}
                    alt="Bloger Name"
                  ...
                  />
                  <div className="ml-3">
                    <h6 className="font-semibold text-xl text-gray-800">Admin</h6>
